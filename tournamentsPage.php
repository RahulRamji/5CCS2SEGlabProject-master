...
?>">
<a href="./addTournament.php" class="add">Add Tournament</a> 
</div>
 <table>
    <tr>
      <th>Tournament</th>
    ...
    { 
      echo '<tr >';
      echo '<td> <a href="./tournament.php?name='.$tour["tName"].'&loc='.$tour["tLoc"].'&date='.$tour["tDate"].'">'.$tour["tName"].'</a></td>';
      echo '<td>'.$tour["tLoc"].'</td>';
      echo "<td>".$tour["tDate"] . "</td>";
      echo "<tr>";
  }
}
